...
"""
Train a PPO agent (or compatible) in a continuous environment and log results.
...
def train_agent(grid_path, agent_name, episodes, iters, sigma, fps, random_seed, no_gui, agent_size, num_runs=5):
    """
    Train the specified PPO agent in the environment for multiple runs and episodes.
